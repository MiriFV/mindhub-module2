...
const contenedorUp = document.querySelector('#contenedorUp')
  ...
  {   let coleccionEventos=''
      for(const evento of eventos){
        ...
        coleccionEventos += `<div class="col ">
                      ...
                      <div class="card-footer row row-cols-2"><div class="col"><small class="text-muted">Price: $${evento.price}</small></div>
